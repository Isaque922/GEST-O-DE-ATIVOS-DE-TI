...
app.listen(port, '0.0.0.0', () => console.log(`API Gestão de Ativos TI na porta ${port}`));    res.status(400).json({ error: error.code === '23505' ? 'Matrícula já cadastrada.' : 'Não foi possível cadastrar o usuário.' });
  }
}));
